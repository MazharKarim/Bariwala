      ...
      <div class="content">
        <div class="row">
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="select">
                        <select id='gMonth1'>
                            <option value=''>--Select Pament Method--</option>
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Cleaner Bill</h4>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Service Charge</h4>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Gas Bill</h4>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Water Bill</h4>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
